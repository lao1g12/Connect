...
<body>
<body>
	<sf:form method="post" action="removeUser" modelAttribute="user">
		First Name <sf:input required="1" type="text" path="profile.firstName" /> <br /> 
		Last Name <sf:input required="1" type="text" path="profile.lastName" /> <br /> 
		...
		Training Start date <sf:input type="date" path="profile.startDate"/>
		Training End date <sf:input type="date" path="profile.endDate"/>
